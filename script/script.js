...
let player = new Player(canvas.width/2, canvas.height/2, 10, 'white', null);
let projectiles = [];
let enemies = [];
let particles = [];
let score = 0;
...
window.addEventListener('keypress', (e) => {
    if(e.key === 'w'){
        ...
        if((player.y - player.speed - player.radius) <= 0){     //set player 1 to the bottom 0
    ...
    if(e.key === 's'){
        ...
        if((player.y - player.speed - player.radius) >= canvas.height){     //set player 1 to the top 0
    ...
    if(e.key === 'a'){
        ...
        if((player.x - player.speed - player.radius) <= 0){         //set player 1 to the right 0
    ...
    if(e.key === 'd'){
        ...
        if((player.x - player.speed - player.radius) >= canvas.width){     //set player 1 to the left 0
